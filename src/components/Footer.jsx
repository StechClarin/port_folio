...
const SvgGitHub = () => (
  <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true">
    <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.5.499.09.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.036 1.531 1.036.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.026 2.747-1.026.546 1.379.202 2.398.1 2.65.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.577.688.482A10.001 10.001 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
  </svg>
);
  ...
  return (
    <footer className="bg-gray-800 text-gray-200 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          <h3 className="text-lg font-semibold text-white uppercase tracking-wider mb-4">Contact Info</h3>
          <p className="mb-3 leading-relaxed">
            N'hésitez pas à me contacter. Je suis ouvert aux opportunités et aux collaborations.
          </p>
          <p className="mb-2">
            <a href={`mailto:${socials.email}`} className="text-purple-400 hover:text-purple-300 transition-colors duration-300">
              {socials.email}
            </a>
          </p>
          <p>{socials.phone}</p>
        ...
        <div>
          <h3 className="text-lg font-semibold text-white uppercase tracking-wider mb-4">Envoyer un Message</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold text-white uppercase tracking-wider mb-4">Suivez-moi</h3>
          <p className="mb-4">Retrouvez-moi sur les plateformes suivantes :</p>
          <div className="flex gap-6">
            <a href={socials.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-300 hover:text-purple-400 hover:scale-110 transform transition-all duration-300">
              <SvgLinkedIn />
            </a>
            <a href={socials.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-300 hover:text-purple-400 hover:scale-110 transform transition-all duration-300">
              <SvgGitHub />
            </a>
      ...
      <div className="text-center text-gray-500 text-sm mt-12 pt-8 border-t border-gray-700">
        <p>&copy; {new Date().getFullYear()} {about.name}. Tous droits réservés.</p>
      </div>
    </footer>
  );
};
