...
const Footer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const messageData = {
      ...
      subject: `Portfolio Contact Form - ${language.toUpperCase()}`,
    };
  ...
  return (
    <footer className="bg-gray-800 text-gray-200 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          <h3 className="text-lg font-semibold text-white uppercase tracking-wider mb-4">
            {language === 'fr' ? 'Contact Info' : 'Contact Information'}
          </h3>
          <p className="mb-3 leading-relaxed">
            {language === 'fr' 
              ? "N'hésitez pas à me contacter. Je suis ouvert aux opportunités et aux collaborations."
              : "Feel free to contact me. I am open to opportunities and collaborations."}
          </p>
          <p className="mb-2">
            <a
        ...
        <div>
          ...
          <p className="mb-4">
            {language === 'fr' 
              ? 'Retrouvez-moi sur les plateformes suivantes :' 
      ...
      <div className="text-center text-gray-500 text-sm mt-12 pt-8 border-t border-gray-700">
        <p>
          &copy; {new Date().getFullYear()} {about.name}. {language === 'fr' ? 'Tous droits réservés.' : 'All rights reserved.'}
        </p>
      </div>
    </footer>
  );
