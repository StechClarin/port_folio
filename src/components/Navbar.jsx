...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-theme-secondary/80 backdrop-blur-md border-b border-violet-800/20 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="text-theme-secondary hover:text-theme-primary focus:outline-none transition-colors p-2"
      ...
      <div
        className={`md:hidden absolute top-20 left-0 w-full bg-theme-secondary/95 backdrop-blur-xl border-b border-violet-800/20 shadow-2xl transition-all duration-300 ease-in-out transform origin-top ${
          isOpen
