    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <p className="text-xl text-gray-200 leading-relaxed text-center">
          {language === 'fr' ? (
            <>
              En tant que développeur Full Stack et spécialiste DevOps, je possède
              un ensemble de compétences solides en Python, Django et React,
              complétées par une expertise secondaire en Laravel et Angular. Ma
              maîtrise s'étend à Docker et GitLab CI pour l'optimisation des
              pipelines CI/CD, et j'ai une excellente connaissance des API REST et
              GraphQL. Titulaire d'un Master en Génie Logiciel et doté d'une
              solide expérience en architecture logicielle, je suis apte à concevoir
              et implémenter des applications scalables et performantes.
            </>
          ) : (
            <>
