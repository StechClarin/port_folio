...
const About = () => {
  ...
  const { bio, bio_en, education, resumeUrl, resumeUrl_en, photoUrl } = about;

  return (
    <section
      id="about"
      className="relative py-20 bg-gray-800/40 border-t border-violet-800/10"
    >
          ...
          <div className="md:w-2/3 bg-gray-800 p-8 rounded-xl shadow-[0_0_30px_rgba(124,58,237,0.3)] border border-violet-800/40">
            <div className="space-y-6 text-gray-200">
              <p className="text-lg leading-relaxed">
                {language === 'fr' ? bio : bio_en}
              </p>

              <div className="mt-6">
                <h3 className="text-2xl font-bold text-white mb-4">
                  {language === 'fr' ? 'Parcours & Formation' : 'Path & Education'}
                </h3>
              ...
              <div className="mt-8 flex justify-center md:justify-start">
                <a
                  href={language === 'fr' ? resumeUrl : (resumeUrl_en || resumeUrl)}
